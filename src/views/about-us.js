  ...
  return (
    <div className="about-us-container">
      <Helmet>
        ...
        <meta property="og:title" content="About-us - Website" />
      </Helmet>
      ...
      <span className="about-us-text">
        <span className="about-us-text01">About Us</span>
        <br></br>
      </span>
      <span className="about-us-text03">
        <br></br>
        <span>Hello this is Emre from Emr3 Studios.</span>
        <br></br>
        <span>I`m a Programmer from Germany. I make Games in Unity</span>
        <br></br>
        <span>I am currently alone so its more I than Us.</span>
        <br></br>
        <br></br>
        <span>So Join the Discord and be apart of a growing Community.</span>
        <br></br>
      </span>
    </div>
  )
